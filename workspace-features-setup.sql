-- Workspace Features and User Management Setup
...
DROP POLICY IF EXISTS "Users can view workspace settings they belong to" ON workspace_settings;
...
DROP POLICY IF EXISTS "Workspace owners can manage settings" ON workspace_settings;
...
DROP POLICY IF EXISTS "Users can view workspace invitations they belong to" ON workspace_invitations;
...
DROP POLICY IF EXISTS "Admins can manage workspace invitations" ON workspace_invitations;
...
ON CONFLICT (workspace_id, feature_name) DO NOTHING;
